...
public class ElementUtil extends BasePage {   // because i use highlightelement from basepage
	 ...
	 * @return
	 */
	public boolean waitForTitlePresent(String title){ // if we want to check title is true or false, we use this one
	...
	public WebElement getElement(By locator) {
		...
		try {
//			if(waitForElementVisible(locator)); this is another approach and it workd for all element 
	 ...
	 * @param value
	 */
	public void doSendKeys(By username, String value) {
		try {
